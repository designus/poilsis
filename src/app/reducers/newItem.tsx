...
import { TItemState, getInitialItemState } from '../containers';

export const FIELD_VALUES = 'fields';
export const VALIDATION_ERRORS = 'errors';
export const SHOW_VALIDATION_ERRORS = 'showErrors';

export const newItem = (state: TItemState = getInitialItemState(), action): TItemState => {
	switch (action.type) {
		case ADD_NEW_ITEM_STATE:
			return action.state;
		case CLEAR_FIELDS:
			return getInitialItemState();
